...
const FormularioProducto = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className={styles.form}>
      ...
      <input className={ styles.input1 } type="text" name="descripcion" placeholder="Tipo de producto" onChange={handleChange} />
      

      <button className={styles.buttonEntrada} type="submit">Crear Producto</button>
    </form>
