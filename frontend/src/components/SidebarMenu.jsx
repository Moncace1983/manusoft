            ...
            <ul>
                ...
                {isProductosOpen && (
                    <ul className={styles.submenu}>
                        <li>
                            <Link to="/crear_producto" onClick={handleSubmenuClick}>Crear producto</Link>
                        </li>
                        <li>
                            <Link to="/entrada_productos" onClick={handleSubmenuClick}>Entrada productos</Link>
                        </li>
                        <li>
                            <Link to="/consulta_inventario" onClick={handleSubmenuClick}>Consulta de inventario</Link>
                        </li>
                        <li>
                            <Link to="/salida_producto" onClick={handleSubmenuClick}>Salida de productos</Link>
                        </li>
                    </ul>
                )}
                
                <li>
                    <Link to="/informes" onClick={toggleSidebar}>Informes</Link>
                </li>
                <button onClick={onLogout} className={styles.button}>Cerrar Sesión</button>
            </ul>
        </div>
